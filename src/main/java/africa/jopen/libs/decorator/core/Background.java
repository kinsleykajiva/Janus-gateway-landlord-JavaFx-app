...
package africa.jopen.libs.decorator.core;



import africa.jopen.libs.decorator.GNDecorator;
...
//            GNBackground.class.getResource("/theme/agent.css").toExternalForm();
    ...
    private static final String DEFAULT_STYLESHEET
            = Background.class.getResource("/styles/dark.css")
            .toExternalForm();

    private static final String LIGHT_STYLESHEET
            = Background.class.getResource("/styles/light.css")
            .toExternalForm();
