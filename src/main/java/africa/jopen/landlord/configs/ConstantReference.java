...
public class ConstantReference {
	...
	public static String  JANUS_SERVER_BASE_URL                     = "http://102.37.58.226";
	...
	public static String  JANUS_SERVER_URL                          = JANUS_SERVER_BASE_URL + ":" + JANUS_SERVER_ADMIN_PORT+ JANUS_SERVER_ADMIN_BASE_PATH;
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ConstantReference.class);
	public static final String SYSTEM_APP_TITLE = "Janus-Gateway-LandLord App";
	protected static final String APP_FOLDER = ".africa/janus-landlord-jfx";
	static final String CONFIG_FILE_SUFFIX = "-configuration.properties";
	protected static final String ENCRYPTION_ALGORITHM = "PBEWithHMACSHA512AndAES_256";
	public static final String DEFAULT_ENCRYPTION_PASSWORD = "SecureJanusKey2025!@#";
	public static volatile String ROOT_FOLDER = "";
